...
export default function App() {
  return (
    <div className="">
      <div className="flex flex-col items-center mt-[12%] sm:mt-[4%] mb-[4%] font-poppins">
        ...
        <div className="mt-6 text-justify sm:text-center text-sm sm:text-xl text-slate-400 pl-[40px] pr-[40px] mb-6 sm:mb-0">
